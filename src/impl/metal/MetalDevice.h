...
namespace gfx {
    ...
    public:
        ...
        virtual TextureId CreateTexture2D(PixelFormat format, const TextureUsageFlags& usage, uint32_t width, uint32_t height, void* data, const std::string& debugName = "") override;
