...
namespace gfx {
    ...
    public:
        ...
        void setShaderBuffer(BufferId buffer, uint8_t index, const ShaderStageFlags& stages) final;
        void setShaderTexture(TextureId texture, uint8_t index, const ShaderStageFlags& stages) final;
